...
// Başlangıç havuzu - İstifleme Vinçleri için güncellendi
const INITIAL_POOL: ImageItem[] = Array.from({ length: 16 }, (_, i) => ({
    id: i + 1,
    src: `https://placehold.co/400x500/${['e2e8f0', 'cbd5e1', '94a3b8', '64748b'][i % 4]}/1e293b?text=Istifleme+Vinci+Uygulama+${i + 1}`,
    title: `Uygulama Örneği ${i + 1}`
}));

export default function StackerCranesPage() {
    // Ana Galeri State'i
    const [activeImage, setActiveImage] = useState(0)
    const images = [
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Istifleme+Vinci+Main",
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Istifleme+Vinci+Detay+1",
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Istifleme+Vinci+Detay+2",
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Istifleme+Vinci+Detay+3"
    ]
        ...
        <div className="bg-white min-h-screen font-sans text-gray-900">
            ...
            >
                <div
                    ...
                    style={{ backgroundImage: `url(https://placehold.co/1920x1080/1a1a1a/ffffff?text=Istifleme+Vincleri)` }}
                >
                ...
                <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                    ...
                    >
                        Zorlu ve merkez dışı noktalara erişim için özel tasarım istifleme çözümleri.
                    </motion.p>
                </div>
            </motion.section>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">
                            Zorlu Alanlarda <span className="text-primary">Maksimum Erişim</span>
                        </h2>
                        ...
                        <div className="bg-gray-50 p-6 rounded-xl border-l-4 border-primary">
                            <h3 className="text-xl font-bold text-gray-900 mb-2">Özel Tasarım Kapasite</h3>
                            <p className="text-gray-600">
                                İstifleme vinçlerinin kaldırma kapasiteleri ve tork değerleri, uygulamanızın özel gereksinimlerine göre özel olarak tasarlanıp üretilebilir.
                            </p>
                        </div>
                    </motion.div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                            İstifleme vinçlerinin endüstriyel sahadaki kullanım senaryoları.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-gray-600">
                                ...
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Ergonomik kontrol ünitesi konumu</li>
                            </ul>
                        </div>
                    </div>
