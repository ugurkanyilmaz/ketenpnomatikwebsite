...
// Başlangıç havuzu - Zeminde Hareketli Sistemler için güncellendi
const INITIAL_POOL: ImageItem[] = Array.from({ length: 16 }, (_, i) => ({
    id: i + 1,
    src: `https://placehold.co/400x500/${['e2e8f0', 'cbd5e1', '94a3b8', '64748b'][i % 4]}/1e293b?text=Mobil+Sistem+Uygulama+${i + 1}`,
    title: `Uygulama Örneği ${i + 1}`
}));

export default function FloorGuidedPage() {
    // Ana Galeri State'i
    const [activeImage, setActiveImage] = useState(0)
    const images = [
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Mobil+Sistem+Main",
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Mobil+Sistem+Detay+1",
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Mobil+Sistem+Detay+2",
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Mobil+Sistem+Detay+3"
    ]
        ...
        <div className="bg-white min-h-screen font-sans text-gray-900">
            ...
            >
                <div
                    ...
                    style={{ backgroundImage: `url(https://placehold.co/1920x1080/1a1a1a/ffffff?text=Zeminde+Hareketli+Sistemler)` }}
                >
                ...
                <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                    ...
                    >
                        Sabitleme gerektirmeyen, yüksek kapasiteli mobil taşıma çözümleri.
                    </motion.p>
                </div>
            </motion.section>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">
                            Özgür ve <span className="text-primary">Güçlü Hareket</span>
                        </h2>
                        ...
                        <div className="bg-gray-50 p-6 rounded-xl border-l-4 border-primary">
                            <h3 className="text-xl font-bold text-gray-900 mb-2">Tam Bağımsızlık</h3>
                            <p className="text-gray-600">
                                Herhangi bir yapıya monte edilmek zorunda olmayan bu cihazlar, tesis içinde ihtiyaç duyulan her noktaya kolayca taşınabilir ve anında kullanıma hazır hale gelir.
                            </p>
                        </div>
                    </motion.div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                            Zeminde hareketli sistemlerin endüstriyel sahadaki kullanım senaryoları.
                        </p>
                    </div>
            ...
            <section className="py-20 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
                        <div>
                            ...
                            <ul className="space-y-2 text-gray-600">
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Elektrikli, hidrolik ve pnömatik strok seçenekleri</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Müşteri gereksinimlerine göre özel tasarım</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Tutuculu veya tutucusuz (Without gripper) seçenekler</li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                            ...
                            <ul className="space-y-2 text-gray-600">
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Buton ile kontrol</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Ayak pompası ile yukarı/aşağı kontrol</li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                            ...
                            <ul className="space-y-2 text-gray-600">
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Entegre fren sistemi</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Tam mobilite ve bağımsız çalışma</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Yüksek kaldırma kapasitesi</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-8 text-center">
                        ...
                        <p className="text-gray-600">
                            Bu ürün grubu, tamamen müşterilerimizin tesis ve yük gereksinimlerine göre (load capacity, stroke, vb.) özel olarak tasarlanmaktadır. Detaylı teknik özellikler ve kapasite bilgileri için lütfen bizimle iletişime geçiniz.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-gray-900 text-white">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <Link
                            to="/kategoriler/manipulatorler/manipulatorler/istifleme-vincleri"
                            className="group bg-gray-800 rounded-xl p-6 hover:bg-gray-700 transition-colors border border-gray-700 hover:border-primary"
                        >
                            <h3 className="text-xl font-bold mb-3 group-hover:text-primary transition-colors">İstifleme Vinçleri</h3>
                            <p className="text-gray-400 text-sm mb-4">Zorlu alanlarda maksimum erişim ve istifleme.</p>
                            <span className="text-primary text-sm font-semibold flex items-center gap-2">
                                İncele
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
