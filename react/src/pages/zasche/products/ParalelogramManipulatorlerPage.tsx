...
// Başlangıç havuzu - Paralelogram için güncellendi
const INITIAL_POOL: ImageItem[] = Array.from({ length: 16 }, (_, i) => ({
    id: i + 1,
    src: `https://placehold.co/400x500/${['e2e8f0', 'cbd5e1', '94a3b8', '64748b'][i % 4]}/1e293b?text=Paralelogram+Uygulama+${i + 1}`,
    title: `Uygulama Örneği ${i + 1}`
}));

export default function ParalelogramPage() {
    // Ana Galeri State'i
    const [activeImage, setActiveImage] = useState(0)
    const images = [
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Paralelogram+Main",
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Paralelogram+Detay+1",
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Paralelogram+Detay+2",
        "https://placehold.co/600x800/e2e8f0/1e293b?text=Paralelogram+Detay+3"
    ]
        ...
        <div className="bg-white min-h-screen font-sans text-gray-900">
            ...
            >
                <div
                    ...
                    style={{ backgroundImage: `url(https://placehold.co/1920x1080/1a1a1a/ffffff?text=Paralelogram+Manipulatorler)` }}
                >
                ...
                <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                    ...
                    >
                        Burulma kuvvetlerini dengeleyen, yüksek hassasiyetli kaldırma çözümleri.
                    </motion.p>
                </div>
            </motion.section>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">
                            Rijit ve <span className="text-primary">Dengeli Kaldırma</span>
                        </h2>
                        ...
                        <div className="bg-gray-50 p-6 rounded-xl border-l-4 border-primary">
                            <h3 className="text-xl font-bold text-gray-900 mb-2">Hafif ve Kompakt Tasarım</h3>
                            <p className="text-gray-600">
                                Optimize edilmiş kesit yapısı ve düşük ölü ağırlığı sayesinde kompakt paralelogram manipülatörlerimiz, özellikle seri üretim ve hafif yük uygulamaları için idealdir.
                            </p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="flex-1 min-h-[300px] lg:h-full bg-gray-100 rounded-xl overflow-hidden shadow-lg relative group">
                            <img
                                ...
                                alt="Paralelogram Manipülatör Detay"
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                            Paralelogram manipülatörlerimizin endüstriyel sahadaki kullanım senaryoları.
                        </p>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
                        <div>
                            ...
                            <ul className="space-y-2 text-gray-600">
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Zemine monte (sütunlu)</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Tavana monte (sabit)</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Asma vinç veya raylı sistemde hareketli</li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                            ...
                            <ul className="space-y-2 text-gray-600">
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Tek, iki veya çoklu yük dengeleme</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Yüksüz dengeleme opsiyonlu yukarı/aşağı kontrol</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Sezgisel el kuvveti algılama (Hand Force Detection)</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Tutucu güvenlik bırakma gibi gelişmiş güvenlik özellikleri</li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                            ...
                            <ul className="space-y-2 text-gray-600">
                                ...
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Bakım ünitesi</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Dönme açısı sensörü</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Kaldırma kilidi (Lifting lock)</li>
                                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 bg-primary rounded-full"></span>Mobil taban plakası</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="overflow-x-auto bg-white rounded-xl shadow-lg border border-gray-100">
                        <table className="w-full text-left border-collapse min-w-[900px]">
                            <thead>
                                <tr className="bg-gray-50 border-b border-gray-200">
                                    ...
                                    <th className="p-4 font-bold text-gray-900">Çalışma Yarıçapı [mm]</th>
                                    <th className="p-4 font-bold text-gray-900">Strok [mm]</th>
                                    <th className="p-4 font-bold text-gray-900">Dönme Aralığı [°]</th>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {[
                                    ...
                                    <tr key={idx} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="p-4">{row.radius}</td>
                        ...
                        <div className="p-4 bg-gray-50 text-sm text-gray-500 border-t border-gray-200">
                            *6 bar basınç ile. Özel tasarımlar talep üzerine mevcuttur.
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-gray-900 text-white">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <Link
                            to="/kategoriler/manipulatorler/manipulatorler/teleskopik-kaldirma"
                            className="group bg-gray-800 rounded-xl p-6 hover:bg-gray-700 transition-colors border border-gray-700 hover:border-primary"
                        >
                            <h3 className="text-xl font-bold mb-3 group-hover:text-primary transition-colors">Teleskopik Kaldırma</h3>
                            <p className="text-gray-400 text-sm mb-4">Düşük tavanlı alanlar için kompakt çözümler.</p>
                            <span className="text-primary text-sm font-semibold flex items-center gap-2">
                                İncele
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
