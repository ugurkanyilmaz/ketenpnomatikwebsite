        ...
        <div className="bg-white min-h-screen font-sans text-gray-900">
            ...
            >
                <div
                    ...
                    style={{ backgroundImage: `url(https://placehold.co/1920x1080/1a1a1a/ffffff?text=Asma+Vinc+Sistemleri)` }}
                >
            ...
            <section className="py-24 px-4 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: 'Çelik Üstyapı / Vinç Destek Yapısı', desc: 'Vinç sistemleri için sağlam ve güvenilir çelik konstrüksiyonlar.' },
                            { title: 'Hafif Vinç Sistemleri', desc: 'Alüminyum profilli, ergonomik hafif vinç rayları.' },
                            { title: 'Pergel Vinçler', desc: 'Belirli bir çalışma alanı için duvara veya zemine monte döner vinçler.' }
                        ].map((item, index) => (
                            <motion.div
                                key={index}
