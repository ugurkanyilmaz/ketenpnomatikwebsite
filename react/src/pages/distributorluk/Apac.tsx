          ...
          <div>
            ...
            <div className="mt-6">
              <div className="mt-4 flex gap-3">
                ...
                <ScrollToTopLink to={`/urunler?brand=${encodeURIComponent('Apac')}`} className="btn btn-outline text-white">Ürünleri Gör</ScrollToTopLink>
              </div>
            </div>
          </div>
          <div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-10 rounded-2xl">
          <div className="grid lg:grid-cols-3 gap-6 items-center rounded-2xl border border-base-300 bg-base-100 p-8">
            ...
            <div className="flex gap-3 lg:justify-end">
              ...
              <ScrollToTopLink to={`/urunler?brand=${encodeURIComponent('Apac')}`} className="btn btn-outline">Ürünleri Gör</ScrollToTopLink>
            </div>
          </div>
        </div>
      </motion.section>
