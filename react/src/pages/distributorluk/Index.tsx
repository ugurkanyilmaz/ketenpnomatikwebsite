...
export default function DistributorlukIndex() {
  ...
  {/* Hiyoki - Koyu Gri Arkaplan (site header ile uyumlu) - Görsel Solda */}
  ...
  {/* Kolver - Koyu Gri Arkaplan (site header ile uyumlu) - Görsel Solda */}
  <div className="bg-slate-800 py-16">
        <motion.section
          initial={{ opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="text-left">
            <div className="badge badge-primary mb-3">Yetkili Distribütör</div>
            <h2 className="text-2xl md:text-3xl font-bold text-white">Kolver</h2>
            <p className="mt-4 text-gray-300 leading-relaxed">
  ...
  {/* Delta Regis - Koyu Gri Arkaplan (site header ile uyumlu) - Görsel Solda */}
  <div className="bg-slate-800 py-16">
        <motion.section
          initial={{ opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* Servis - Beyaz Arkaplan - Görsel Sağda */}
      <div className="bg-white py-16">
        <motion.section
          initial={{ opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="text-left">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Keten Pnömatik Hakkında</h2>
            <p className="mt-4 text-gray-700 leading-relaxed">
              Endüstriyel montaj, ölçüm ve pnömatik sistemlerde uçtan uca çözümler sunuyoruz. Yetkili distribütörlüğünü yaptığımız markalarla; ürün seçimi, projelendirme, kurulum, eğitim ve satış sonrası destek süreçlerinin tamamında yanınızdayız.
            </p>
          ...
          >
            <img 
              src={serviceImg?.image_path || '/technical_service_banner.png'} 
              alt={serviceImg?.alt_text || 'Keten Pnömatik Teknik Servis'} 
              className="rounded-box shadow-xl w-full object-contain" 
              loading="lazy" 
            />
          </motion.div>
            ...
            <div className="rounded-2xl bg-slate-900/90 backdrop-blur-sm p-10 grid lg:grid-cols-3 gap-6 items-center text-white">
              <div className="lg:col-span-2">
                ...
                <p className="mt-3 text-gray-200 max-w-xl">
                  Uygulamanıza uygun ürün seçimi, projelendirme ve devreye alma için bizimle iletişime geçin.
                </p>
              </div>
